...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        case "story":
            ...
            /** it says n=2 cuz one is the word "story" thje other is actuall string */
        ...
        case "dog":
            ...
            dog_name =  args[1];
            dog_type = args[2];
            dog_age = Integer.valueOf(args[3]);
            /** peristently make a new dog and save it to a file */
            CapersRepository.makeDog(dog_name,dog_type,dog_age);
