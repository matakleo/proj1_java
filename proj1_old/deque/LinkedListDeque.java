...
//        sentinel.next.prev=
    ...
    private class LinkedListDequeueIterator implements Iterator<T> {
        private int wizPos;
        private LinkedListDeque<T> iteratorLinkedList;
        public LinkedListDequeueIterator(LinkedListDeque<T> L) {
            iteratorLinkedList = L;
        ...
        public boolean hasNext() {
            ...
            /** if sentinel.next points to sentinel, return false */

            return iteratorLinkedList.sentinel.next!=iteratorLinkedList.sentinel;
        }
        @Override
        public T next() {
            if (!hasNext()){
